...
#   secret_id = aws_secretsmanager_secret.rds_credentials_pvt.id
#   secret_string = jsonencode({
#     db_user     = aws_db_instance.postgres_private.username
#     db_password = random_password.db_admin_password.result
#     db_endpoint = aws_db_instance.postgres_private.endpoint
#     db_name     = aws_db_instance.postgres_private.db_name
#     db_engine   = "postgres"
#     db_port     = 5432
#   })
# }
...
#   subnet_id     = aws_subnet.lumifi_private_subnets[0].id
#   tags = {
